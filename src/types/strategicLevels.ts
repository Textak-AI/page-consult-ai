...
export const STRATEGIC_LEVELS: Record<StrategicLevel, LevelDefinition> = {
  ...
  armed: {
    ...
    requiredFields: ['industry', 'audience', 'valueProp', 'competitorDifferentiation', 'painPoints', 'buyerObjections'],
  ...
  proven: {
    ...
    requiredFields: ['industry', 'audience', 'valueProp', 'competitorDifferentiation', 'painPoints', 'buyerObjections', 'proofElements'],
