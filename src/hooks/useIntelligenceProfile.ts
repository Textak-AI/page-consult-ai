...
// Uses Full values (max 50 chars) for content generation, not truncated display values
export function mapDemoToConsultation(demoIntelligence: any): ExtractedIntelligence {
  return {
    // Use Full values for content generation, fallback to short values
    industryVertical: demoIntelligence.industryFull || demoIntelligence.industry || undefined,
    industryVerticalSource: (demoIntelligence.industryFull || demoIntelligence.industry) ? 'demo' : undefined,
    ...
    buyerRole: demoIntelligence.audienceFull || demoIntelligence.audience || undefined,
    buyerRoleSource: (demoIntelligence.audienceFull || demoIntelligence.audience) ? 'demo' : undefined,
    ...
    coreOffer: demoIntelligence.valuePropFull || demoIntelligence.valueProp || undefined,
    coreOfferSource: (demoIntelligence.valuePropFull || demoIntelligence.valueProp) ? 'demo' : undefined,
    ...
    keyDifferentiator: demoIntelligence.competitorDifferentiatorFull || demoIntelligence.competitorDifferentiator || demoIntelligence.competitive || undefined,
    keyDifferentiatorSource: (demoIntelligence.competitorDifferentiatorFull || demoIntelligence.competitorDifferentiator || demoIntelligence.competitive) ? 'demo' : undefined,
    proofElements: demoIntelligence.proofElementsFull || demoIntelligence.proofElements || undefined,
    proofElementsSource: (demoIntelligence.proofElementsFull || demoIntelligence.proofElements) ? 'demo' : undefined,
    ...
    primaryPainPoint: demoIntelligence.painPointsFull || demoIntelligence.painPoints || undefined,
    primaryPainPointSource: (demoIntelligence.painPointsFull || demoIntelligence.painPoints) ? 'demo' : undefined,
    commonObjections: demoIntelligence.buyerObjectionsFull || demoIntelligence.buyerObjections || undefined,
    commonObjectionsSource: (demoIntelligence.buyerObjectionsFull || demoIntelligence.buyerObjections) ? 'demo' : undefined,
