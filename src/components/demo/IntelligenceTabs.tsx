...
function getClientLayoutIntelligence(industry: string | null, audience: string | null): { pageStructure: PageStructureItem[]; layoutIntelligence: LayoutIntelligence } {
...
function EnhancedStrategyBriefWrapper({
  ...
  // Get layout intelligence based on industry
  const { pageStructure, layoutIntelligence } = useMemo(() => {
    return getClientLayoutIntelligence(state.extracted.industry, state.extracted.audience);
