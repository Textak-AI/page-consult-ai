...
const Hero = () => {
  return (
    <section className="relative pt-32 pb-20 px-6 min-h-screen overflow-hidden bg-gradient-to-b from-[#1e1b4b] via-[#0f0a1f] to-[#000000] opacity-0 animate-fade-in" style={{ animationDuration: '1000ms' }}>
      ...
      <div className="absolute -top-6 left-12 w-56 h-24 hidden lg:block z-0 animate-float opacity-0" style={{ animationDelay: '1s', animationDuration: '4s', animation: 'fade-in 800ms ease-out 1000ms forwards, float 4s ease-in-out infinite', willChange: 'transform' }}>
      ...
      <div className="absolute bottom-24 right-12 w-48 h-20 hidden lg:block z-0 animate-float opacity-0" style={{ animation: 'fade-in 800ms ease-out 1000ms forwards, float 5s ease-in-out 1s infinite', willChange: 'transform' }}>
        <div className="bg-slate-800/40 backdrop-blur-xl border border-white/5 rounded-2xl p-4 shadow-2xl">
          <div className="flex items-center gap-3">
      ...
      <div className="absolute left-4 md:left-8 top-1/2 -translate-y-1/2 w-64 h-28 hidden lg:block z-10 animate-float opacity-0" style={{ animation: 'fade-in 800ms ease-out 1000ms forwards, float 6s ease-in-out 2s infinite', willChange: 'transform' }}>
        <div className="bg-slate-800/40 backdrop-blur-xl border border-white/5 rounded-2xl p-4 shadow-2xl">
          <div className="flex items-center gap-3">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-slide-up max-w-2xl opacity-0" style={{ animation: 'slide-up 800ms ease-out 200ms forwards' }}>
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed mt-6 max-w-xl antialiased opacity-0" style={{ textRendering: 'optimizeLegibility', animation: 'fade-in 800ms ease-out 400ms forwards' }}>
              AI consultant asks intelligent questions, then builds professional
              pages proven to convert. No templates. No guesswork.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mt-12 opacity-0" style={{ animation: 'fade-in 800ms ease-out 600ms forwards' }}>
            ...
            <p className="text-gray-500 text-sm text-center sm:text-left mt-3 opacity-0" style={{ animation: 'fade-in 800ms ease-out 700ms forwards' }}>
              No credit card required • See results in 2 minutes
            </p>
          </div>

          <div className="animate-scale-in relative opacity-0" style={{ animation: 'scale-in 1000ms ease-out 800ms forwards' }}>
            <AnimatedChatPreview />
          </div>
        </div>
      </div>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce-slow hidden md:flex transition-colors duration-300 group cursor-default">
