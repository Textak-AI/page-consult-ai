...
import { archetypes, getDefaultArchetype } from "./archetypes.ts";
import { industryConfigs, getAllAliases, industryConfigsById } from "./industries/index.ts";
...
function matchByKeywords(industry: string): KeywordMatch | null {
  const keywordMap: Record<string, { archetype: string; confidence: number }> = {
    ...
    // Local service keywords (comprehensive list)
    plumber: { archetype: "local-service", confidence: 0.9 },
    plumbing: { archetype: "local-service", confidence: 0.9 },
    plumb: { archetype: "local-service", confidence: 0.85 },
    electrician: { archetype: "local-service", confidence: 0.9 },
    electrical: { archetype: "local-service", confidence: 0.85 },
    electric: { archetype: "local-service", confidence: 0.7 },
    hvac: { archetype: "local-service", confidence: 0.9 },
    heating: { archetype: "local-service", confidence: 0.8 },
    cooling: { archetype: "local-service", confidence: 0.8 },
    "air conditioning": { archetype: "local-service", confidence: 0.9 },
    roofing: { archetype: "local-service", confidence: 0.9 },
    roofer: { archetype: "local-service", confidence: 0.9 },
    roof: { archetype: "local-service", confidence: 0.75 },
    landscaping: { archetype: "local-service", confidence: 0.9 },
    landscaper: { archetype: "local-service", confidence: 0.9 },
    "lawn care": { archetype: "local-service", confidence: 0.9 },
    lawn: { archetype: "local-service", confidence: 0.75 },
    dentist: { archetype: "local-service", confidence: 0.85 },
    dental: { archetype: "local-service", confidence: 0.85 },
    restaurant: { archetype: "local-service", confidence: 0.8 },
    catering: { archetype: "local-service", confidence: 0.8 },
    salon: { archetype: "local-service", confidence: 0.85 },
    barber: { archetype: "local-service", confidence: 0.85 },
    spa: { archetype: "local-service", confidence: 0.8 },
    contractor: { archetype: "local-service", confidence: 0.85 },
    handyman: { archetype: "local-service", confidence: 0.9 },
    repair: { archetype: "local-service", confidence: 0.7 },
    cleaning: { archetype: "local-service", confidence: 0.85 },
    maid: { archetype: "local-service", confidence: 0.85 },
    janitorial: { archetype: "local-service", confidence: 0.85 },
    "pest control": { archetype: "local-service", confidence: 0.9 },
    exterminator: { archetype: "local-service", confidence: 0.9 },
    moving: { archetype: "local-service", confidence: 0.8 },
    mover: { archetype: "local-service", confidence: 0.85 },
    "auto repair": { archetype: "local-service", confidence: 0.9 },
    mechanic: { archetype: "local-service", confidence: 0.85 },
    garage: { archetype: "local-service", confidence: 0.7 },
    towing: { archetype: "local-service", confidence: 0.85 },
    locksmith: { archetype: "local-service", confidence: 0.9 },
    painter: { archetype: "local-service", confidence: 0.85 },
    painting: { archetype: "local-service", confidence: 0.85 },
    flooring: { archetype: "local-service", confidence: 0.85 },
    carpet: { archetype: "local-service", confidence: 0.8 },
    tile: { archetype: "local-service", confidence: 0.75 },
    window: { archetype: "local-service", confidence: 0.7 },
    glass: { archetype: "local-service", confidence: 0.7 },
    "garage door": { archetype: "local-service", confidence: 0.9 },
    appliance: { archetype: "local-service", confidence: 0.8 },
    pool: { archetype: "local-service", confidence: 0.8 },
    "tree service": { archetype: "local-service", confidence: 0.9 },
    arborist: { archetype: "local-service", confidence: 0.9 },
    gutter: { archetype: "local-service", confidence: 0.85 },
    "pressure wash": { archetype: "local-service", confidence: 0.85 },
    "power wash": { archetype: "local-service", confidence: 0.85 },
    drywall: { archetype: "local-service", confidence: 0.85 },
    concrete: { archetype: "local-service", confidence: 0.8 },
    mason: { archetype: "local-service", confidence: 0.8 },
    fencing: { archetype: "local-service", confidence: 0.85 },
    fence: { archetype: "local-service", confidence: 0.8 },
    siding: { archetype: "local-service", confidence: 0.85 },
    insulation: { archetype: "local-service", confidence: 0.85 },
    solar: { archetype: "local-service", confidence: 0.8 },
    septic: { archetype: "local-service", confidence: 0.9 },
    well: { archetype: "local-service", confidence: 0.7 },
    "water treatment": { archetype: "local-service", confidence: 0.85 },
    homeowner: { archetype: "local-service", confidence: 0.6 },
    residential: { archetype: "local-service", confidence: 0.6 },
